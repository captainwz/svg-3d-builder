...
function getOneNewControl(control) {
    ...
    newControl.a2y = [1 / 2 * a3[0] + 1 / 2 * a2b[0], 1 / 2 * a3[1] + 1 / 2 * a2b[1], 1 / 2 * a3[2] + 1 / 2 * a2b[2]];

    // ab2' = 1/4*a3 + 1/2*a2b + 1/4*ab2, b <-> y
    newControl.ay2 = [1 / 4 * a3[0] + 1 / 2 * a2b[0] + 1 / 4 * ab2[0], 1 / 4 * a3[1] + 1 / 2 * a2b[1] + 1 / 4 * ab2[1], 1 / 4 * a3[2] + 1 / 2 * a2b[2] + 1 / 4 * ab2[2]];

    // b3 = 1/8*a3 + 3/8*a2b + 3/8*ab2 + 1/8*b3, b <-> y
    newControl.y3 = [1 / 8 * a3[0] + 3 / 8 * a2b[0] + 3 / 8 * ab2[0] + 1 / 8 * b3[0], 1 / 8 * a3[1] + 3 / 8 * a2b[1] + 3 / 8 * ab2[1] + 1 / 8 * b3[1], 1 / 8 * a3[2] + 3 / 8 * a2b[2] + 3 / 8 * ab2[2] + 1 / 8 * b3[2]];

    // a2y = a2y, b <-> y
    newControl.a2b = [a2y[0], a2y[1], a2y[2]];
    ...
    newControl.by2 = [1 / 4 * a2y[0] + 1 / 2 * aby[0] + 1 / 4 * b2y[0], 1 / 4 * a2y[1] + 1 / 2 * aby[1] + 1 / 4 * b2y[1], 1 / 4 * a2y[2] + 1 / 2 * aby[2] + 1 / 4 * b2y[2]];

    // ay2 = ay2, b <-> y
    newControl.ab2 = [ay2[0], ay2[1], ay2[2]];

    // by2 = 1/2*ay2 + 1/2*by2, b <-> y
    newControl.b2y = [1 / 2 * ay2[0] + 1 / 2 * by2[0], 1 / 2 * ay2[1] + 1 / 2 * by2[1], 1 / 2 * ay2[2] + 1 / 2 * by2[2]];

    // y3 = y3, b <-> y
    newControl.b3 = [y3[0], y3[1], y3[2]];
